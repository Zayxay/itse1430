...
class Shop
{
    ...
    private void DisplayMenu ()
    {
        ...
        Console.WriteLine("Option 4. Modify Oredr");
        ...
        try
        {
            ...
            switch (myOptions)
            {
                ...
                case 4: ModifyOrder(_processorName, _processorPrice, _memName, _memPrice, _orderTotal); break;
    ...
    private void ModifyOrder ( string itemName, decimal icost, string memoryName, decimal memoryCost, decimal cart )
    {
        ...
        } else
        {
            ...
            Console.WriteLine("========================");
            Console.WriteLine($"{itemName:C2} for {icost:C2}");
            Console.WriteLine($"{memoryName:C2} for {memoryCost:C2}");
            Console.WriteLine("==============");
    ...
    private void ModifyProcessor (  )
    {
        ...
        try
        {
            switch (response)
            {
                case 1: _processorName="AMD Ryzen 9 5900X"; _processorPrice=1410; _orderTotal=_processorPrice + _memPrice; DisplayMenu(); break;
                case 2: _processorName="AMD Ryzen 7 5700X"; _processorPrice=1270; _orderTotal=_processorPrice + _memPrice; DisplayMenu(); break;
                case 3: _processorName="AMD Ryzen 5 5600X"; _processorPrice=1200; _orderTotal=_processorPrice + _memPrice; DisplayMenu(); break;
                case 4: _processorName="Intel i9-12900K"; _processorPrice=1590; _orderTotal=_processorPrice + _memPrice; DisplayMenu(); break;
                case 5: _processorName="Intel i7-12700K"; _processorPrice=1400; _orderTotal=_processorPrice + _memPrice; DisplayMenu(); break;
                case 6: _processorName="Intel i5-12600K"; _processorPrice=1200; _orderTotal=_processorPrice + _memPrice; DisplayMenu(); break;
                default: Error(); break;
            }
        } catch (FormatException)
        {
